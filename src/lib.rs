// src/lib.rs
/*
 * Core library for HealthMonitor
 */
...
#[derive(Debug)]
pub struct HealthMonitorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HealthMonitorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HealthMonitor processing");
    
    let mut processor = HealthMonitorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HealthMonitorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HealthMonitorProcessor::new(false);
